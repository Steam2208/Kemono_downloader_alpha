...
echo 📋 Build Results:
echo ================
if exist "dist\KemonoDownloader_GUI_v2.7_Multithread.exe" (
    echo ✅ GUI version: KemonoDownloader_GUI_v2.7_Multithread.exe
) else (
    echo ❌ GUI version: FAILED!
)

if exist "dist\KemonoDownloader_Console_v2.7_Multithread.exe" (
    echo ✅ Console version: KemonoDownloader_Console_v2.7_Multithread.exe
) else (
